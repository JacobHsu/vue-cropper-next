...
<script setup lang="ts">
  ...
  const homeLabel = computed(() => (isEn.value ? 'Home' : '首頁'))
  ...
  const navGroups = computed(() => [
    {
      ...
      items: [
        {
          name: isEn.value ? 'Guide' : '快速開始',
          path: '/guide'
        },
        {
          name: isEn.value ? 'Props' : '參數',
          path: '/props'
        },
        {
        ...
        {
          name: isEn.value ? 'Changelog' : '版本記錄',
          path: '/changelog'
        },
        {
    ...
    {
      title: isEn.value ? 'Demos' : '範例',
      items: [
        {
          name: isEn.value ? 'Basic Demo' : '基礎範例',
          path: '/demo-basic'
        },
        {
          name: isEn.value ? 'Export' : '導出能力',
          path: '/demo-export'
        },
        {
        ...
        {
          name: isEn.value ? 'Loading Slot' : '替換 loading 範例',
          path: '/demo-loading'
        },
        {
          name: isEn.value ? 'Upload & Drag' : '本地上傳圖片範例',
          path: '/demo-drag'
        },
        {
          name: isEn.value ? 'Crop Box' : '截圖框操作',
          path: '/demo-crop'
        },
        {
          name: isEn.value ? 'Boundary' : '邊界控制',
          path: '/demo-img'
        },
        {
          name: isEn.value ? 'Filter' : '圖片濾鏡',
          path: '/demo-filter'
        },
        {
          name: isEn.value ? 'Rotation' : '旋轉控制',
          path: '/demo-rotate'
        },
        {
          name: isEn.value ? 'Realtime Preview' : '即時預覽',
          path: '/demo-realtime'
        }
      ]
    }
